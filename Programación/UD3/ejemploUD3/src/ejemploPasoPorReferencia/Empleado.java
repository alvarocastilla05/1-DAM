...
public class Empleado {
	...
	//Se le pasa como parámetro un objeto de la clase fecha y comprueba si el día y mes pasados 
	//en la fecha como parámetro, coinciden con los del objeto que llama, si es así, felicita.
